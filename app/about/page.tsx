    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Lexend, sans-serif' }}>
      ...
      <section className="bg-gradient-to-br from-blue-900 to-purple-900 text-white py-16 sm:py-24 px-4 sm:px-6 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">About Nestoria</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-16 sm:mb-20">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              At Nestoria, we believe everyone deserves to find the perfect home. Our mission is to revolutionize the real estate experience by making property discovery, purchasing, and investment accessible, transparent, and trustworthy for everyone.
            </p>
          ...
          <div className="mb-16 sm:mb-20">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              Nestoria was founded with a simple vision: to make real estate simple. What started as a small team of passionate professionals has grown into a trusted platform serving thousands of satisfied customers.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mb-4">
              Over the years, we've continuously refined our approach, invested in technology, and expanded our portfolio to serve clients globally. Today, Nestoria stands as a beacon of trust and innovation in the real estate industry.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
